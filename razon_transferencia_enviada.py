    ...
    def resolver(self,transaccion,evento):
        ...
        if self.cuenta_corriente == None:
            if transferencia_con_costo < self.caja_ahorro_pesos.limite_extraccion_diario:
                if transaccion.saldoEnCuenta > transferencia_con_costo:
                    pass
                else:
            ...
            if transferencia_con_costo < self.caja_ahorro_pesos.limite_extraccion_diario:
                if transaccion.saldoEnCuenta > transferencia_con_costo:
                    ...
                    if (transaccion.saldoEnCuenta - transferencia_con_costo < -1*(self.cuenta_corriente.saldo_descubierto_disponible)):
                ...
                return f'La transferencia supera los ${self.caja_ahorro_pesos.limite_extraccion_diario} que es tu limite de extracción diario'
