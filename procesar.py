...
from tipos_clientes import Black
        ...
        if t.estado == "RECHAZADA":
            match t.tipo.lower():
                case 'transferencia_enviada':
                    print(RazonTransferenciaEnviada(t,evento).resolver()) #en vez de print va return para mandar los datos a una variable
                case 'transferencia_recibida':
                    print(RazonTransferenciaRecibida(t,evento).resolver())
